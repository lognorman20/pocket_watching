...
public class TokenAnalyticsAdapter extends RecyclerView.Adapter<TokenAnalyticsAdapter.ViewHolder> {
    private Context context;
    private List<Token> tokens;

    public TokenAnalyticsAdapter(Context context, List<Token> inputTokens) {
    ...
    @NonNull
    @Override
    public TokenAnalyticsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_token, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull TokenAnalyticsAdapter.ViewHolder holder, int position) {
